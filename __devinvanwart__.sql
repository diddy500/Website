...
insert  into `customers`(`Email`,`FName`,`LName`,`Title`,`Password`,`HomeTele`,`WorkTele`,`Address1`,`Address2`,`Province`,`ccType`,`ccName`,`ccMonth`,`ccYear`,`LanguagePref`,`InterestSpaceX`,`InterestTesla`,`InterestHyper`) values 
('devin.vanwart@gmail.com','Devin','Vanwart','Mr','1q2w3e','472-3130','847-2755','590 Montgomery st.','apt 4','New Brunswick','Visa','DEVIN VANWART',2,2016,'English',0,1,0);
...
('TESL001',NULL,'Model S P85D','-nice desc-','ModelS','Tesla',61,120000,NULL,NULL,NULL,NULL,NULL,NULL,NULL,20),
...
('TESL004',NULL,'Model X P85D','--','ModelX','Tesla',56,80000,NULL,NULL,NULL,NULL,NULL,NULL,NULL,15),
