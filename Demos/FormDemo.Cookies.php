                        ...
                        <table border="1" cellpadding="3" style="border-collapse: collapse" bordercolor="#cccccc" width="500" bgcolor="#ffffff" height="142">
                            ...
                            <tr>
                                <td width="250" height="38">
                                    ...
                                    <font face="arial"> 
                                    <input type="radio" name="language" value="Fran�ais" <?php echo ($strLanguage == 'Fran�ais') ? ('CHECKED="CHECKED"') : ('') ?> >
                                    </font>
                                    <font size="2" face="arial"> Fran�ais&nbsp; </font>
                                    <font face="arial">
                                    <input type="radio" name="language" value="Espa�ol" <?php echo ($strLanguage == 'Espa�ol') ? ('CHECKED="CHECKED"') : ('') ?> >
                                    </font>
